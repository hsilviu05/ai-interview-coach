...
\texttt{CreatedByUserId}       & \texttt{uuid}           & FK$\rightarrow$Users, NOT NULL & ON DELETE CASCADE \\
\texttt{CreatedAt}             & \texttt{timestamp with time zone} & NOT NULL & \\
\texttt{UpdatedAt}             & \texttt{timestamp with time zone} & NOT NULL & \\
\hline
\end{tabular}
...
\hline
\texttt{Id}             & \texttt{uuid}    & PK, NOT NULL                 & \\
\texttt{ProblemId}      & \texttt{uuid}    & FK$\rightarrow$Problems, NOT NULL        & ON DELETE CASCADE \\
...
\hline
\texttt{Id}          & \texttt{uuid}    & PK, NOT NULL                  & \\
\texttt{InterviewId} & \texttt{uuid}    & FK$\rightarrow$Interviews, NOT NULL       & ON DELETE Cascade \\
\texttt{ProblemId}   & \texttt{uuid}    & FK$\rightarrow$Problems, NOT NULL         & ON DELETE Restrict \\
\texttt{OrderIndex}  & \texttt{integer} & NOT NULL                      & \\
...
\texttt{Id}          & \texttt{uuid}           & PK, NOT NULL               & \\
\texttt{InterviewId} & \texttt{uuid}           & FK$\rightarrow$Interviews, NOT NULL    & ON DELETE Cascade \\
\texttt{CandidateId} & \texttt{uuid}           & FK$\rightarrow$Users, NOT NULL         & ON DELETE Restrict \\
...
\texttt{CandidateId}        & \texttt{uuid}        & FK$\rightarrow$Users, NOT NULL         & ON DELETE Restrict \\
\texttt{ProblemId}          & \texttt{uuid}        & FK$\rightarrow$Problems, NOT NULL      & ON DELETE Cascade \\
\texttt{InterviewSessionId} & \texttt{uuid}        & FK$\rightarrow$InterviewSessions, NULL & ON DELETE Cascade; NULL $\rightarrow$ practică \\
...
\hline
\texttt{Id}                     & \texttt{uuid}    & PK, NOT NULL                 & \\
\texttt{CandidateId}            & \texttt{uuid}    & FK$\rightarrow$Users, NOT NULL, UNIQUE   & relație 1-la-1 \\
...
\hline
\texttt{Id}                & \texttt{uuid}           & PK, NOT NULL              & \\
\texttt{AdminUserId}       & \texttt{uuid}           & FK$\rightarrow$Users, NOT NULL        & ON DELETE Restrict \\
