...
\begin{enumerate}
  ...
  \item \texttt{ExceptionHandlingMiddleware} înfășoară restul pipeline-ului
        ...
        mapate la coduri HTTP: \texttt{KeyNotFoundException}$\rightarrow$404,
        \texttt{UnauthorizedAccessException}$\rightarrow$403,
        \texttt{InvalidOperationException}$\rightarrow$400, altele$\rightarrow$500.
