...
\begin{itemize}
  ...
  \item \texttt{roleGuard}: citește politica de acces din datele rutei
        ...
        \begin{itemize}
          \item Utilizator neautentificat → redirecționare la \texttt{/login}.
          \item Utilizator cu alt rol → redirecționare la ruta implicită
                a rolului (\texttt{getDefaultRouteForRole()}):
                Interviewer/Admin → \texttt{/interviewer/dashboard},
                Candidate → \texttt{/candidate/access}.
        \end{itemize}
