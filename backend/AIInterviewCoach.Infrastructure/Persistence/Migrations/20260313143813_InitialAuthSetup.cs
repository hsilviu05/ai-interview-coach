        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AverageExecutionTimeMs = table.Column<int>(type: "integer", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CandidateStatistics", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CandidateStatistics_Users_CandidateId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CandidateStatistics_CandidateId",
                table: "CandidateStatistics",
                column: "CandidateId",
                unique: true);
